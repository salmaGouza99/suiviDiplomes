...
function GuichetRetrait(props) {
    ...
    const handleCallbackNav = (childData) => {
        ...
        childData === '1' && setTitle("Diplômes En attente du retrait");
        childData === '2' && setTitle("Diplômes retirés");
...
GuichetRetrait.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(GuichetRetrait);
